...
import { Opensea, NFT } from './opensea.js';
...
class Farm {
    ...
    async Inventory(): Promise<Array<Item>> {
        ...
        for (let idx = 0; idx < nfts.length; idx++) {
            ...
            if (nft.contract.trim().toLowerCase() == inventoryContractAddress.trim().toLowerCase()) {
                ...
                promises.push(inventory.methods.balanceOf(this.address, nft.identifier).call().then((amount) => {
